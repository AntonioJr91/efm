...
@Service
public class ListFarmAreaUseCase {

   private final FarmAreaJpaRepository farmAreaJpaRepository;

   public ListFarmAreaUseCase(FarmAreaJpaRepository farmAreaJpaRepository) {
      this.farmAreaJpaRepository = farmAreaJpaRepository;
   }

   @Transactional(readOnly = true)
   public List<FarmAreaResponse> execute() {
      return FarmAreaMapper.toDtoList(farmAreaJpaRepository.findAll());
   }
}
